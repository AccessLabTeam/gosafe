...
<form name="index" action="" method="post" id="index">
...
e.preventDefault();
if($("#index [name='your_title']").val() === '')
{
$("#index [name='your_title']").css("border","1px solid red");
}
else if ($("#index [name='your_email']").val() === '')
{
$("#index [name='your_email']").css("border","1px solid red");
}
else
{
...
$("#index").find("input[type=text], input[type=email], textarea, input[type=file]").val("");
}
